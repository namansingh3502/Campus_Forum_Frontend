...
export default function EditPostDialog (props){
  ...
  const [selectedChannels, setSelectedChannels] = useState(props.data.post.posted_in)
          ...
          >
            ...
            >
              <div className="h-full w-full bg-gray-400 rounded-lg border-0 bg-opacity-20 backdrop-filter text-amber-50">
                ...
                >
                  <span className="font-medium text-center w-full">Edit Post</span>
                  <button
                    type={"button"}
                    onClick={()=>{
                      props.setDialogVisibility()
                ...
                >
                  ...
                  <form onSubmit={(e) => {
                    ...
                    <ChannelSelect
                      ...
                      setSelectedChannel={channels => setSelectedChannels(channels)}
                    />
