  ...
  return (
    <div className="flex my-2">
      <div className="w-full bg-transparent">
        <div className={"mx-2"}>
          <h1 className="inline-block mb-2 text-gray-400 text-xl font-medium ml-2">
            Add Images
          </h1>
          <div className="flex flex-wrap text-black">
            ...
            {props.images.length < 6 ? (
              <div
                className={
                  "h-36 w-1/3 mb-1 border-2 border-gray-500 hover:border-gray-200 hover:text-gray-200 border-dashed"
                }
              >
